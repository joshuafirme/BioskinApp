           ...
           <div class="col-sm-12">
            <div class="float-right">
                ...
                @php
                    ...
                    $_addr1 = isset($address->province) ? $address->province : "" ." ".isset($address->municipality) ? $address->municipality : ""
                    ." ".isset($address->brgy) ? $address->brgy : "" ." ".isset($address->detailed_loc) ? $address->detailed_loc : ""; 
                    $_addr2 = "";

...
@php
    $page_title = "VCS | Create subcategory";
@endphp

<div class="content-header"></div>

    <div class="page-header mb-3">
        <h3 class="mt-2" id="page-title">Create subcategory</h3>
        <hr>
                        ...
                        <div class="row">
                           ...
                           <!-- <div class="col-sm-12 col-md-6 mb-2">    
                              ...
                              <div class="col-12 mt-4">
                                ...
                                <a href="{{ route('subcategory.index') }}" class="btn btn-sm btn-default" data-dismiss="modal">Cancel</a>
                              </div>

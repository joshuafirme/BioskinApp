            ...
            <div class="container registration-container">
                <div class="row py-5 ">
                    ...
                    <div class="col-md-5 pr-lg-5 mb-5 mb-md-0 ml-sm-0 ml-lg-5">
                        <img src="{{ asset('images/undraw_fill_form_re_cwyf.svg') }}" alt=""
                        ...
                        <form action="{{ action('UserController@doSignup') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="input-group col-lg-12 mb-4">
                                    ...
                                    <input id="phoneNumber" type="tel" name="phone_no" placeholder="Phone Number"
                            ...
                            <div class="w-100 mt-3">
                                <p class="text-muted">Already Registered? <a href="{{ url('/login') }}"
